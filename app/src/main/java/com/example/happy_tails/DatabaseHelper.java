...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "HappyTailsDatabase.db";
// user table
    ...
    public void addWalkingActivity(WalkingActivity walkingActivity){
        ...
        values.put(COLUMN_WALKINGACTIVITY_WALKINGDATE, walkingActivity.getWalkingDate().toString());
        values.put(COLUMN_WALKINGACTIVITY_WALKINGSTARTTIME, walkingActivity.getWalkingStartTime().toString());
        values.put(COLUMN_WALKINGACTIVITY_WALKINGENDTIME, walkingActivity.getWalkingEndTime().toString());
    ...
    public ArrayList<WalkingActivity> getAllWalkingActivities(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                walkingActivity.setWalkingDate(LocalDate.parse(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGDATE))));
                walkingActivity.setWalkingStartTime(LocalTime.parse(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGSTARTTIME))));
                walkingActivity.setWalkingEndTime(LocalTime.parse(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGENDTIME))));
                walkingActivity.setTotalWalkingTime(Long.parseLong(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_TOTALWALKINGTIME))));
    ...
    public WalkingActivity getSpecificWalkingActivity(int walkingID) {
        ...
        if (c != null) {
            ...
            specificWalkingActivity.setWalkingDate(LocalDate.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGDATE))));
            specificWalkingActivity.setWalkingStartTime(LocalTime.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGSTARTTIME))));
            specificWalkingActivity.setWalkingEndTime(LocalTime.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGENDTIME))));
            specificWalkingActivity.setTotalWalkingTime(Long.parseLong(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_TOTALWALKINGTIME))));
    ...
    public WalkingActivity getlastWalkingActivity() {
        ...
        if (c != null) {
            ...
            lastWalkingActivity.setWalkingDate(LocalDate.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGDATE))));
            lastWalkingActivity.setWalkingStartTime(LocalTime.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGSTARTTIME))));
            lastWalkingActivity.setWalkingEndTime(LocalTime.parse(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGENDTIME))));
            lastWalkingActivity.setTotalWalkingTime(Long.parseLong(c.getString(c.getColumnIndex(COLUMN_WALKINGACTIVITY_TOTALWALKINGTIME))));
    ...
    public ArrayList<String> getAllWalkingActivityWalkingDates(int userID){
        ...
        if (cursor.moveToFirst()){
            do {
                WalkingActivity walkingActivity = new WalkingActivity();
                walkingActivity.setWalkingDate(LocalDate.parse(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_WALKINGDATE))));
                String walkingDate = walkingActivity.getWalkingDate().toString();
    ...
    public ArrayList<Long> getAllWalkingActivityTotalWalkingTime(int userID){
        // array of columns to fetch
        String[] columns = {
                COLUMN_WALKINGACTIVITY_TOTALWALKINGTIME,
        };
        ...
        ArrayList<Long> walkingActivityWalkingTimeList= new ArrayList<Long>();
        ...
        if (cursor.moveToFirst()){
            do {
                WalkingActivity walkingActivity = new WalkingActivity();
                walkingActivity.setTotalWalkingTime(Long.parseLong(cursor.getString(cursor.getColumnIndex(COLUMN_WALKINGACTIVITY_TOTALWALKINGTIME))));
                long totalWalkingTime = walkingActivity.getTotalWalkingTime();
